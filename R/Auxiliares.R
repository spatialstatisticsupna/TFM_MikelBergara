# Funcion para definir un procedimiento de creacion de conjuntos de validacion (capítulo 4)
# Argumentos:
...
validation_subsets <- function(inicio = NULL, final = NULL, prediccion = NULL, vec_temporal = NULL, datos = NULL, y = NULL){
  ...
  # El siguiente bucle sirve para identificar el indice de la columna de la componente temporal
  ...
  # El siguiente bucle sirve para identificar el indice de la columna de la variable de observaciones
  ...
  while ((indice_final+prediccion) <= length(vec_temporal)) { 
    ...
    # Clave para la creacion de nuevos subconjuntos: actualizar en una unidad los indices para pasar exactamente al siguiente ano
