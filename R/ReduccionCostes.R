...
# Cargar la base de datos correspondiente al periodo 2001-2017: data2001_2017.RData
...
####################################################################################################
# Se comparan las distribuciones a posteriori de los hiperparametros junto a su mediana 
...
### APENDICE B ###
##################
# Por ultimo se dibujan las distribuciones de los hiperparametros del modelo completo 2001_2017 
# comparandolas con el modelo del subperiodo 2001_2013 control.mode(..., Restart=TRUE) para ver si la optimizacion de los hiperparametros cambia mucho
graphics.off()
...
######################################################################################################################
# Se comparan las tasas estimadas en el periodo 2001_2013 por ambos modelos (se puede hacer para todos los subperiodos)
...
### APENDICE B ###
##################
# Se construye tambien un diagrama de dispersion de los predictores lineales en el periodo 2001_2013
# Se comparan como en los mapas anteriores, los predictores dados por ambos modelos. 
# Se muestran por cada ano del subperiodo los valores dados en cada region
...
# Se ve claramente que los predictores lineales dados por los modelos son practicamente identicos
# Ver si hay ligeras diferencias entre modelos si se exponencian estos predictores (es decir, se estiman las tasas)
...
######################################################################################################
# Calculo de tiempos de ejecucion de los cuatro modelos BYM ajustados en el periodo completo 2001_2017
...
### APENDICE A ###
##################
# Calculo de tiempos de ejecucion de los modelos anteriores para cada subperiodo
# Creacion de los 5 subconjuntos utilizados (igual que en ValidationProcess.R)
...
# 2) control.mode(..., Restart == TRUE) se sigue optimizando los hiperparametros partiendo del modelo para el periodo completo
# 3) control.mode(..., Restart == FALSE) se consideran los hiperparametros del modelo del periodo completo
R_s <- Rs1
...
# Calculo de tiempo total para los modelos de cada metodo
